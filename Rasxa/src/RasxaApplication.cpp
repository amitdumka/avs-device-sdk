...
#include "Rasxa/ConnectionObserver.h"
#include "Rasxa/GuiRenderer.h"
#include "Rasxa/KeywordObserver.h"
#include "Rasxa/RasxaApplication.h"
...
static const std::string SAMPLE_APP_CONFIG_KEY("rasxaApp");
...
std::unique_ptr<RasxaApplication> RasxaApplication::create(
